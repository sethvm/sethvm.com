  ...
  return (
    <div className='sidebar'>
        <div className='side_items animated fadeInLeft'>
            <a href={resumeFile} target={'blank'}><img src={resumeLogo} alt={'Resume'} className='side_logo' /></a>
            <p><br /></p>
            ...
            <p><br /></p>
            <a href={'mailto:sethvm64@gmail.com?cc=svmoreno@uwaterloo.ca'} target={'_blank'}><img src={contactLogo} className='side_logo' /></a>
        </div>
    </div>
  );
}
